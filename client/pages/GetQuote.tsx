          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            <section className="bg-white/80 p-6 rounded-xl shadow">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* GST Toggle Section */}
<div className="mb-6">
  <h2 className="text-lg font-semibold mb-4">GST</h2>
  <div className="flex gap-4">
    ...
    >
      <p className="font-medium">Previous GST</p>
      <p className="text-lg font-bold text-gray-800">
        ₹{capacityKw ? (computeCurrentCost(capacityKw) + 5000).toLocaleString() : "-"}
      </p>
      <p className="line-through text-gray-500 text-sm">
        ₹{capacityKw ? computeCurrentCost(capacityKw).toLocaleString() : "-"}
      </p>
    </button>
    ...
    >
      <p className="font-medium">Current GST</p>
  ...
  {/* Estimated Cost */}
  {capacityKw && (
    <div className="mt-4 p-3 rounded-md bg-green-50 text-green-700 font-medium">
