          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-12 text-gray-700">
            ...
            <div>
              ...
              <p>
                ...
                remember information such as your preferences, login details,
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  ...
                  Required for the operation of our website (e.g., login,
                  navigation).
                </li>
                <li>
                ...
                <li>
                  ...
                  the website to remember your choices such as language or
                  region.
                </li>
                <li>
            ...
            <div>
              ...
              <p>
                ...
                advertising providers that also place cookies on your device.
                These cookies are managed by third parties and are subject to
