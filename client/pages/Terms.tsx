        ...
        <section className="bg-gradient-to-r from-solar-600 to-energy-500 text-white py-16">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-lg max-w-2xl mx-auto">
              Please read these Terms of Service carefully before using AXISO
              Green Energy’s website and services.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-12 text-gray-700">
            ...
            <div>
              ...
              <p>
                ...
                compliance with all applicable laws and regulations. Misuse of
                our services may result in termination of access.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                this site are owned by AXISO Green Energy or our licensors. You
            ...
            <div>
              ...
              <p>
                To the fullest extent permitted by law, AXISO Green Energy shall
                not be liable for any damages arising from the use or inability
                to use our services, including indirect or consequential
                damages.
              </p>
            </div>
