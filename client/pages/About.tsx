...
export default function About() {
  ...
  const certifications = [
    ...
    },
    {
      ...
      description:
        "Registered with Telangana State Renewable Energy Development Corporation for renewable energy projects.",
      icon: Award,
      colorBg: "bg-green-500/10",
      colorFg: "text-green-700",
    },
    {
      title: "TGSPDCL",
      subtitle: "Power Distribution",
      description:
        "Authorized partner with Telangana State Power Distribution Corporation for solar installations.",
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        "Registered with New & Renewable Energy Development Corporation of Andhra Pradesh.",
      icon: Globe,
      colorBg: "bg-purple-500/10",
      colorFg: "text-purple-700",
    },
    {
      title: "ISO 9001",
      ...
      colorFg: "text-orange-700",
    },
    {
      title: "ISO 14001",
      subtitle: "Environmental Management",
      description:
        "Environmental management system certification for sustainable business practices.",
      icon: Leaf,
      colorBg: "bg-emerald-500/10",
      colorFg: "text-emerald-700",
    },
  ];

  const CARD_WIDTH_PX = 384; // w-96
  const CARD_GAP_PX = 40; // gap-10 = 2.5rem = 40px
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* Certifications & Affiliations - Horizontal Scrolling with Navigation */}
        <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Recognitions and partnerships that validate our commitment to quality, safety, and clean energy leadership in India.
              </p>
            </motion.div>
            ...
            <div className="relative">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="absolute -left-6 md:-left-8 top-1/2 transform -translate-y-1/2 z-10 bg-white/95 hover:bg-white border-2 border-gray-200 hover:border-primary/30 rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm"
                aria-label="Previous certification"
              >
                <ChevronLeft className="h-6 w-6 text-gray-600 hover:text-primary transition-colors" />
              </motion.button>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.1, x: 5 }}
                whileTap={{ scale: 0.95 }}
                className="absolute -right-6 md:-right-8 top-1/2 transform -translate-y-1/2 z-10 bg-white/95 hover:bg-white border-2 border-gray-200 hover:border-primary/30 rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm"
                aria-label="Next certification"
              >
                <ChevronRight className="h-6 w-6 text-gray-600 hover:text-primary transition-colors" />
              </motion.button>
              ...
              <div className="overflow-x-hidden">
                ...
                >
                  {certifications.map((cert, index) => (
                    ...
                    >
                      <Card className="h-72 border-gray-200 hover:border-primary/20 transition-all duration-300 hover:shadow-xl bg-white">
                        <CardContent className="p-10 flex flex-col items-center justify-center h-full text-center">
                          <motion.div
                            whileHover={{ scale: 1.1, rotate: 5 }}
                            className={`w-20 h-20 ${cert.colorBg} rounded-2xl flex items-center justify-center mb-6 shadow-lg`}
                          >
                            {React.createElement(cert.icon, {
                              className: `h-10 w-10 ${cert.colorFg}`
                            })}
                          </motion.div>
                          
                          <h3 className={`text-2xl font-bold ${cert.colorFg} mb-3`}>
                            {cert.title}
                          </h3>
                          
                          <p className="text-xl text-primary/80 font-semibold mb-4">
                            {cert.subtitle}
                          </p>
