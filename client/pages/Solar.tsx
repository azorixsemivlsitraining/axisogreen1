...
export default function Solar() {
  ...
  const solarImages = [
    "https://cdn.builder.io/api/v1/image/assets%2F5c07bd532d434c36b4bb2918deeee627%2F6b13b66c40c1461eb78b5e4cfd4f7914?format=webp&width=800",
    "https://cdn.builder.io/api/v1/image/assets%2F5c07bd532d434c36b4bb2918deeee627%2F11e10bc14fe74ae6b42cde71e8eaedbb?format=webp&width=800",
    "https://cdn.builder.io/api/v1/image/assets%2F5c07bd532d434c36b4bb2918deeee627%2Fba5332782dd642b6a4640eb4bf00fc36?format=webp&width=800",
  ];
          ...
          >
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen">
              ...
              <div className="text-center lg:text-left order-2 lg:order-1">
                ...
                >
                  <span className="block pb-3 bg-gradient-to-r from-solar-600 via-energy-500 to-sky-600 bg-clip-text text-transparent">
                    Solar Energy
                  </span>
                </motion.h1>
